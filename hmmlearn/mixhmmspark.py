...
class MultinomialMixHMM(_BaseMixHMM):
    ...
    def fit(self, sc, data, **kwargs):
        ...
        return super(MultinomialMixHMM, self).fit(self, sc, data, **kwargs)
...
class MultinomialExponentialMixHMM(_BaseMixHMM):
    ...
    def fit(self, sc, data, **kwargs):
        ...
        return super(MultinomialExponentialMixHMM, self).fit(self, sc, cleaned_data, **kwargs)
...
class PoissonMixHMM(_BaseMixHMM):
    ...
    def fit(self, sc, data, **kwargs):
        ...
        return super(PoissonMixHMM, self).fit(self, sc, data, **kwargs)
...
class ExponentialMixHMM(_BaseMixHMM):
    ...
    def fit(self, sc, data, **kwargs):
        ...
        return super(ExponentialMixHMM, self).fit(self, sc, data, **kwargs)
...
class GaussianMixHMM(_BaseMixHMM):
    ...
    def fit(self, sc, data, **kwargs):
        ...
        obs : list
            ...
            the i_th observation.
        """
        return super(GaussianMixHMM, self).fit(self, sc, data, **kwargs)
